...
import org.vivlaniv.nexohub.mobile.cards.pictures.HumidifierCanvas
import org.vivlaniv.nexohub.mobile.cards.property.EnumDeviceProperty
import org.vivlaniv.nexohub.mobile.cards.property.HumidityDeviceProperty
...
fun HumidifierCard(
    ...
    val humidity = remember(shouldRefresh) {
        device.findProperty("humidity")
    }
        ...
        Surface(
            ...
            Row(
                ...
                Row(
                    ...
                    DeviceFrame {
                        HumidifierCanvas(turn.value, humidity.value)
                    }
                    Column {
                        Text(
        ...
        AnimatedVisibility(
            ...
            Column(
                ...
                HumidityDeviceProperty(
                    propertyInfo = humidity,
                    putPropertyCallback = { onPutProperty(humidity.name, it) },
                    shouldRefresh = shouldRefresh
                )
            }
        }
